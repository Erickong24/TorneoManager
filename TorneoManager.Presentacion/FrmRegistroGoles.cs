...
{
    public partial class FrmRegistroGoles : Form
    {
        ...
        public FrmRegistroGoles(int idPartido)
        {
            InitializeComponent();
        ...
        private void FrmRegistroGoles_Load(object sender, EventArgs e)
        {
            Tema.AplicarEstiloBoton(btnAgregar, true);
            Tema.AplicarEstiloGrid(dgvGoles);
        ...
        {
            dgvGoles.DataSource = _partidoService.ListarGoles(_idPartido);
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _partidoService.RegistrarGol(gol);
